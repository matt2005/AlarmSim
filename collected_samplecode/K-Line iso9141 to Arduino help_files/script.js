...
$(function()
{
	$('.buttonlist > .dropmenu').each(function(index, item)
	{
		$(item).prev().click(function(e)
		{
			...
			/*Arduino Theme Fix Style*/
			var ClassName = $(item).context.className;
			$(item).css('display', 'block');
			// if(ClassName.indexOf('notify_dropdown') == -1)
			$(item).css('top', $(this).offset().top - 240);
			// else
			// 	$(item).css('top', '77px');
...
/*Arduino Style*/
	$( '.bbc_code' ).each( function( i, e ){
		$(e).css({
				'max-height' : 'none',
				'height' : ( e.scrollHeight > 200 ? '200px' : 'auto' ) });
	});
